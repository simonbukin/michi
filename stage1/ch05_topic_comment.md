...
> それは わたしの かばんです。
> "That (near you) is my bag."

> あれは 大学です。
> "That (over there) is a university."

> どれが たなかさんのですか。
> "Which one is Tanaka-san's?"
...
| あそこ | ⓪ | over there |
| どこ | ① | where |
| こちら | ⓪ | this way, here (polite) |
| そちら | ① | that way (polite) |
| あちら | ⓪ | over that way (polite) |
| どちら | ① | which way, where (polite) |
...
| Japanese | Pitch | Function |
|----------|-------|----------|
| は | — | topic marker (pronounced わ) |
| の | — | possession / noun modification |
| も | — | also, too (replaces は) |
| か | — | question marker |
| です | — | polite copula (is/am/are) |
| じゃありません | — | polite negative copula (is not) |
| ではありません | — | polite negative copula, formal variant |
...
| どうぞ よろしく おねがいします | — | please treat me well (closing of introduction) |
