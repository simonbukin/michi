...
| 五段 endings | Examples |
|---|---|
| ～く | かく (write), きく (listen) |
| ～ぐ | およぐ (swim), いそぐ (hurry) |
| ～す | はなす (speak), だす (put out) |
| ～つ | まつ (wait), たつ (stand) |
| ～ぬ | しぬ (die) |
| ～ぶ | あそぶ (play), よぶ (call) |
| ～む | のむ (drink), よむ (read) |
| ～う | かう (buy), あう (meet) |
| ～る | つくる (make), かえる (return) |

| 一段 endings | Examples |
|---|---|
| ～いる | みる (see), おきる (wake up) |
| ～える | たべる (eat), ねる (sleep) |
...
| たべる（食べる） | to eat | 一段 |
| みる（見る） | to see | 一段 |
| おきる（起きる） | to wake up | 一段 |
| ねる（寝る） | to sleep | 一段 |
| でる（出る） | to go out | 一段 |
| きる（着る） | to wear | 一段 |
| いれる（入れる） | to put in | 一段 |
| あける（開ける） | to open | 一段 |
...
| 辞書形の末尾 | い-row に変換 | 例：辞書形 → ます-form |
|---|---|---|
| ～く | ～き | かく → か**き**ます |
| ～ぐ | ～ぎ | およぐ → およ**ぎ**ます |
| ～す | ～し | はなす → はな**し**ます |
...
|  | 非過去 (non-past) | 過去 (past) |
|---|---|---|
| 肯定 (affirmative) | たべます | たべました |
| 否定 (negative) | たべません | たべませんでした |
...
| Form | How to make it |
|---|---|
| ます | base form — polite non-past affirmative |
| ました | replace ます with ました — polite past affirmative |
| ません | replace ます with ません — polite non-past negative |
| ませんでした | replace ます with ませんでした — polite past negative |
...
| よむ | よみます | to read | ① |
| のむ | のみます | to drink | ① |
| きく | ききます | to listen, to ask | ⓪ |
| はなす | はなします | to speak, to talk | ② |
| いく | いきます | to go | ⓪ |
| かう | かいます | to buy | ⓪ |
| まつ | まちます | to wait | ① |
| あう | あいます | to meet | ① |
| つくる | つくります | to make, to create | ② |
| あそぶ | あそびます | to play, to hang out | ⓪ |
| しぬ | しにます | to die | ⓪ |
| すわる | すわります | to sit | ⓪ |
| たつ | たちます | to stand | ① |
| もつ | もちます | to hold, to have | ① |
...
|---|---|---|---|
| たべる | たべます | to eat | ② |
| みる | みます | to see, to watch, to look | ① |
| おきる | おきます | to wake up, to get up | ② |
| ねる | ねます | to sleep, to go to bed | ⓪ |
| でる | でます | to go out, to leave | ① |
| いれる | いれます | to put in, to insert | ⓪ |
| あける | あけます | to open | ⓪ |
| しめる | しめます | to close | ② |
| おしえる | おしえます | to teach, to tell | ⓪ |
| つける | つけます | to turn on, to attach | ② |
...
| noun + する | ます-form | 意味 | ピッチ（名詞） |
|---|---|---|---|
| べんきょうする | べんきょうします | to study | ⓪ |
| りょうりする | りょうりします | to cook | ① |
| さんぽする | さんぽします | to take a walk | ⓪ |
| せんたくする | せんたくします | to do laundry | ⓪ |
| そうじする | そうじします | to clean | ⓪ |
| かいものする | かいものします | to shop, to go shopping | ⓪ |
| でんわする | でんわします | to make a phone call | ⓪ |
| うんどうする | うんどうします | to exercise | ⓪ |
| れんしゅうする | れんしゅうします | to practice | ⓪ |
| しょくじする | しょくじします | to have a meal | ⓪ |

All four ます variants apply exactly as with する:

|  | 非過去 | 過去 |
|---|---|---|
| 肯定 | べんきょうします | べんきょうしました |
| 否定 | べんきょうしません | べんきょうしませんでした |
...
| 辞書形 | ます-form | 意味 | ピッチ |
|---|---|---|---|
| かえる（帰る） | かえります | to return (home) | ① |
| はしる（走る） | はしります | to run | ② |
| しる（知る） | しります | to know | ⓪ |
| はいる（入る） | はいります | to enter | ① |
| きる（切る） | きります | to cut | ① |
...
| 語 | 意味 |
|---|---|
| ます-form | polite non-past verb form |
