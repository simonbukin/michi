...
| 辞書形 (Dictionary Form) | て-Form | Meaning |
|--------------------------|---------|---------|
| たべる | たべて | eat |
| みる | みて | see, look |
| おきる | おきて | wake up, get up |
| ねる | ねて | sleep, go to bed |
| あける | あけて | open |
| しめる | しめて | close |
| でる | でて | go out, leave |
| いれる | いれて | put in |
...
| Pattern | From | Result | Memory Key |
|---------|------|--------|------------|
| 1 | ～く | ～いて | く → いて |
| 2 | ～ぐ | ～いで | ぐ → いで (voiced version of Pattern 1) |
| 3 | ～す | ～して | す → して (unique) |
| 4 | ～つ, ～う, ～る | ～って | っ + て |
| 5 | ～ぬ, ～ぶ, ～む | ～んで | ん + で |
...
|-----|------|--------|---------|
| たべる | eat | ② | たべて |
| みる | see, look, watch | ① | みて |
| おきる | get up, wake up | ② | おきて |
| ねる | sleep, go to bed | ⓪ | ねて |
| あける | open | ⓪ | あけて |
| しめる | close | ② | しめて |
| でる | go out, leave | ① | でて |
| いれる | put in, insert | ⓪ | いれて |
| おしえる | teach, tell | ⓪ | おしえて |
| かりる | borrow | ⓪ | かりて |
...
|-----|------|--------|---------|
| かく | write | ① | かいて |
| きく | listen, hear, ask | ⓪ | きいて |
| あるく | walk | ② | あるいて |
| はたらく | work (at a job) | ⓪ | はたらいて |
| ひく | pull; play (instrument) | ⓪ | ひいて |
| はく | put on (shoes, pants) | ⓪ | はいて |
| およぐ | swim | ② | およいで |
| ぬぐ | take off (clothes) | ① | ぬいで |
| いそぐ | hurry | ② | いそいで |
...
| うたう | sing | ⓪ | うたって |
| あらう | wash | ⓪ | あらって |
| かえる | return, go home | ① | かえって |
| つくる | make, create | ② | つくって |
| のる | ride, get on | ⓪ | のって |
| おくる | send | ⓪ | おくって |
| はいる | enter | ① | はいって |
| しる | know | ⓪ | しって |
...
|-----|------|--------|---------|
| しぬ | die | ⓪ | しんで |
| あそぶ | play, hang out | ⓪ | あそんで |
| よぶ | call | ⓪ | よんで |
| とぶ | fly, jump | ⓪ | とんで |
| のむ | drink | ① | のんで |
| よむ | read | ① | よんで |
| やすむ | rest, take a day off | ② | やすんで |
| すむ | live, reside | ① | すんで |
