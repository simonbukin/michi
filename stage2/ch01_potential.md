...
| 辞書形 | 語尾の変化 | 可能形 | 意味 |
|--------|-----------|--------|------|
| 書く | く → ける | 書ける | can write |
| 読む | む → める | 読める | can read |
| 話す | す → せる | 話せる | can speak |
| 待つ | つ → てる | 待てる | can wait |
| 飲む | む → める | 飲める | can drink |
| 泳ぐ | ぐ → げる | 泳げる | can swim |
| 遊ぶ | ぶ → べる | 遊べる | can play |
| 死ぬ | ぬ → ねる | 死ねる | can die |
| 買う | う → える | 買える | can buy |
| 作る | る → れる | 作れる | can make |
...
> 字が　小さくて　見えない。
> "The characters are so small I can't see them."
...
> 声が　小さくて　聞こえない。（こえ）
> "Your voice is so quiet I can't hear it."
...
| 単語 | 読み | アクセント | 品詞 | 英語 |
|------|------|-----------|------|------|
| 可能形 | かのうけい | ⓪ | 名詞 | potential form |
| 弾く | ひく | ⓪ | 五段 | to play (instrument) |
| 泳ぐ | およぐ | ② | 五段 | to swim |
| 届く | とどく | ② | 五段 | to arrive, to reach |
| 見える | みえる | ② | 一段 | to be visible |
| 聞こえる | きこえる | ⓪ | 一段 | to be audible |
| 字 | じ | ① | 名詞 | character, letter |
| 声 | こえ | ① | 名詞 | voice |
| 意味 | いみ | ① | 名詞 | meaning |
| 記事 | きじ | ① | 名詞 | article (newspaper) |
| 看板 | かんばん | ⓪ | 名詞 | sign, signboard |
| 切符 | きっぷ | ⓪ | 名詞 | ticket |
| 注文 | ちゅうもん | ⓪ | 名詞 / する | order (at restaurant) |
| 無料 | むりょう | ⓪ | 名詞 | free of charge |
| 旅行 | りょこう | ⓪ | 名詞 / する | travel, trip |
| 美術館 | びじゅつかん | ③ | 名詞 | art museum |
| 簡単 | かんたん | ⓪ | な形容詞 | simple, easy |
| 上手 | じょうず | ③ | な形容詞 | skilled, good at |
| 聞き取る | ききとる | ③ | 五段 | to catch (what is said), to make out |
| 払う | はらう | ② | 五段 | to pay |
| ピアノ | — | ⓪ | 名詞 | piano |
| ラジオ | — | ① | 名詞 | radio |
| サイト | — | ① | 名詞 | website |
| アプリ | — | ① | 名詞 | app (application) |
| だいたい | — | ⓪ | 副詞 | mostly, roughly |
