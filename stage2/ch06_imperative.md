...
べんきょうする → べんきょうしろ ("Study!")
もってくる → もってこい ("Bring it!")
...
> 立入禁止（たちいりきんし）
> "No entry" (literally: "entering prohibited")

> さわるな
> "Don't touch" (on museum displays, etc.)

> 止まれ（とまれ）
> "Stop" (traffic sign — imperative of 止まる)
...
> 助けて！（たすけて）
> "Help!" (て-form used as a plea — not technically imperative, but serves the same function)
...
> はやく　食べな。
> "Eat quickly." (casual, motherly)

> もう　行きなよ。
> "You should go already." (casual advice/nudge)
