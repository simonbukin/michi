...
> 健康のために野菜をたくさん食べるようにしている。
> For my health, I try to eat a lot of vegetables.

> 家族に会うために国に帰った。
> I went back to my country in order to see my family.
...
> ✓ 私は日本語を勉強するために日本に来た。
> (I study / I came — same subject)

> ✗ 子供が勉強するために私は静かにした。
> (The child studies / I was quiet — different subjects → use ように)
...
> [plain form (past or present)] + ために
> [noun + の] + ために
...
> 仕事が忙しいために、なかなか友達に会えない。
> Because work is busy, I can't easily meet friends.

> 病気のために会社を休んだ。
> I was absent from work because of illness.
...
|---|---|---|
| Verb form | dictionary form (non-past) | past form or state |
| Logic | action A is done so that B will happen | B happened because of A |
| Subject | same subject in both clauses | can be different subjects |
| Example | 合格するために勉強する | 事故のために遅れた |
...
> 試験に合格するために勉強する。
> I study in order to pass the exam. (purpose — passing has not happened yet)

> 試験に落ちたために、もう一年勉強することにした。
> Because I failed the exam, I decided to study for one more year. (reason — failing already happened)
...
> 聞こえるように大きい声で話した。
> I spoke in a loud voice so that (it) could be heard.

> 忘れないようにメモを書いた。
> I wrote a memo so that I would not forget.

> 遅刻しないように早く出た。
> I left early so that I would not be late.

> 子供が分かるように簡単な言葉で説明した。
> I explained in simple words so that the child would understand.
...
> 母が心配しないように毎日電話する。
> I call every day so that my mother won't worry.
...
> みんなに見えるように大きく書いた。
> I wrote in large characters so that everyone could see.
...
> 夜十一時までに寝るようにしている。
> I make sure to go to bed by eleven at night.
...
> 今日から早く起きるようにする。
> Starting today, I will make an effort to wake up early. (new resolution)

> 毎朝早く起きるようにしている。
> I make an effort to wake up early every morning. (ongoing practice)
...
> 毎日走ることにした。
> I decided to run every day. (firm decision)

> 毎日走るようにしている。
> I try to run every day. (effort — implies it doesn't always happen)
...
> 子供が一人で着替えられるようになった。
> The child became able to dress by himself.

> 最近、朝早く起きられるようになった。
> Recently, I have become able to wake up early in the morning.
...
> 最近、あまりテレビを見ないようになった。
> Recently, I have stopped watching TV much. (I came to a state of not watching)

> 大人になって、甘い物を食べないようになった。
> After becoming an adult, I stopped eating sweets.
...
> 日本語が話せる。
> I can speak Japanese. (current state)

> 日本語が話せるようになった。
> I became able to speak Japanese. (describes the change)
...
> 大学に入ってから、よく本を読むようになった。
> After entering university, I came to read books often.

> 日本に来てから、毎日お米を食べるようになった。
> After coming to Japan, I came to eat rice every day.
...
| Sentence | Why this form? |
|---|---|
| 日本語を**勉強する**ために日本に来た。 | 勉強する is volitional, same subject → ために |
| 日本語が**話せる**ように毎日練習する。 | 話せる is potential (non-volitional) → ように |
| **忘れない**ようにメモした。 | 忘れない is negative (non-volitional outcome) → ように |
| 試験に**合格する**ために勉強する。 | 合格する is volitional, same subject → ために |
| 子供が**分かる**ように簡単に話した。 | Different subjects → ように |
| お金を**貯める**ために働いている。 | 貯める is volitional, same subject → ために |
| **遅刻しない**ように早く起きた。 | 遅刻しない is negative → ように |
...
|---|---|---|---|---|
| 将来 | しょうらい | ① | noun | future |
| 健康 | けんこう | ⓪ | noun / な-adjective | health; healthy |
| 健康診断 | けんこうしんだん | ⓪ | noun | health checkup |
| 体重 | たいじゅう | ⓪ | noun | body weight |
| 血圧 | けつあつ | ⓪ | noun | blood pressure |
| 増える | ふえる | ② | 一段 verb | to increase (intransitive) |
| 減る | へる | ⓪ | 五段 verb | to decrease (intransitive) |
| 減らす | へらす | ⓪ | 五段 verb | to reduce (transitive) |
| 慣れる | なれる | ② | 一段 verb | to get used to |
| 貯める | ためる | ⓪ | 一段 verb | to save (money) |
| 合格する | ごうかくする | ⓪ | する verb | to pass (an exam) |
| 練習 | れんしゅう | ⓪ | noun / する verb | practice |
| 調べる | しらべる | ③ | 一段 verb | to investigate, to look up |
| レシピ | れしぴ | ① | noun | recipe |
| 簡単 | かんたん | ⓪ | な-adjective | simple, easy |
| 散歩 | さんぽ | ⓪ | noun / する verb | walk, stroll |
| 台風 | たいふう | ③ | noun | typhoon |
| 事故 | じこ | ① | noun | accident |
| 少しずつ | すこしずつ | — | adverb | little by little |
| できるだけ | できるだけ | ⓪ | adverb | as much as possible |
