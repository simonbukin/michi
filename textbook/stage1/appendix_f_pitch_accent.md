...
With a particle: あめ**が** → 「HL-L」 — the particle が is low, continuing the drop.
...
With a particle: たまご**が** → 「LHL-L」 — pitch is already low before the particle arrives.
...
With a particle: はし**が** → 「LH-L」 — the drop falls on が. Compare to 平板型 はし⓪ + が → 「LH-H」 — no drop.
...
With a particle: さくら**が** → 「LHHH-H」 — everything stays high after the initial rise.
...
1. Count the morae: た・ま・ご = 3拍.
2. The number ② means the pitch drops after mora 2.
3. Build the pattern: mora 1 is low (initial rise rule), mora 2 is high, mora 3 is low → L-H-L.
4. If a particle follows, it will also be low because the drop already happened.

For ⓪:

> さくら⓪ — 桜 — cherry blossom

1. Count the morae: さ・く・ら = 3拍.
2. ⓪ means no drop.
3. Pattern: L-H-H, and particles stay high too → L-H-H-H.
...
1. Count: う・み = 2拍.
2. ① means drop after mora 1.
3. Pattern: H-L. Particles are also low → H-L-L.
