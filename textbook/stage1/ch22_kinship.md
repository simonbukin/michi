...
> おじさん = uncle (or a middle-aged man)
> おじいさん = grandfather (or an elderly man)
...
1. **そんけいご (respectful language):** verbs and expressions that elevate the actions of the そと person.
2. **けんじょうご (humble language):** verbs and expressions that lower the actions of the うち person (yourself or your group).
3. **ていねいご (polite language):** the ます/です forms you already use, which set the overall tone of politeness.
