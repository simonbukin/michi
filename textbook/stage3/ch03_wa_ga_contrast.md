...
- **は** marks the element the speaker treats as **already known** to the listener — something shared, established, or presupposed. The new information is in the **comment** that follows は.
- **が** marks the element that **is itself the new information** — the thing being identified, announced, or introduced.

In a は sentence, the new information is in the predicate:

> 田中さん**は**先生です。
> The listener already knows who Tanaka is. The new information is that he's a teacher.

In a が sentence, the new information is in the subject:

> 田中さん**が**先生です。
> The listener already knows someone is a teacher. The new information is that it's Tanaka.
...
|---------|----------------|-----------------|
| X は Y | X (topic) | Y (comment) |
| X が Y | Y (predicate) | X (subject) |
...
> 田中さん**は**どこに行きましたか。→ 田中さん**は**大阪に行きました。
...
> 猫**は**いる。
> "The cat is here." / "As for the cat, it exists." (topic: the cat; comment: it's here)
>
...
> 猫**が**いる。
> "There's a cat." / "A cat is there." (new information: a cat exists in this location)
>
...
> 誰**が**来た？
> "Who came?" (asking for identification of the new-information subject)

> ？ 誰**は**来た？
> This is ungrammatical in most contexts. は marks known information, but 誰 ("who") is inherently unknown — you cannot topicalize something you cannot identify. This is why question words like 誰, 何, どこ almost always pair with が, not は.
...
> 田中さん**は**学生です。
> "Tanaka is a student." (neutral statement — Tanaka is the topic, being-a-student is the news)

> 田中さん**が**学生です。
> "Tanaka is the student." (identification — someone in this group is the student, and I'm telling you it's Tanaka)
...
> 水**は**飲んだ。
> "Water, I drank." (contrastive は — I drank water, implying: but not something else, or: water at least)

> 水**が**飲みたい。
> "I want to drink water." (water is the が-marked object of the stative predicate 飲みたい — see Section 2.3 for が with stative predicates)

### 雨は降っている vs 雨が降っている

> 雨**は**降っている。
> "The rain is falling." / "As for the rain, it's falling." (topic — the rain was already being discussed, or the speaker is confirming its status)

> 雨**が**降っている。
> "It's raining." / "Rain is falling." (new observation — the speaker is reporting or noticing the rain)
...
| Sentence | は reading | が reading |
|----------|-----------|-----------|
| 猫＿いる | The cat is here (known cat) | There's a cat (new notice) |
| 田中さん＿来た | Tanaka came (about Tanaka) | Tanaka came (Tanaka = the one) |
| 田中さん＿学生です | Tanaka is a student (about Tanaka) | Tanaka is the student (identifying) |
| 雨＿降っている | The rain is falling (status) | It's raining (observation) |
| 日本語＿難しい | Japanese is difficult (known topic) | Japanese is difficult (announcing) |
...
> 田中さん**は**来る。
> "As for Tanaka, he's coming." (but what about the others? — this sounds like a partial answer with a contrast)

### What-about questions use は → answers use は

> 田中さん**は**何を持ってくる？
> "What is Tanaka bringing?"
>
> 田中さん**は**ケーキを持ってくる。
> "Tanaka is bringing cake."
...
> どの本**が**おもしろかった？
> "Which book was interesting?"
>
> この本**が**おもしろかった。
> "This book was interesting." (this one = the one)
...
> 牛乳**は**ある。
> "Milk, there is." (implying: but maybe not other things you wanted)
...
> 田中さん**は**去年東京に引っ越した。新しいアパートは駅から近くて便利だそうだ。毎日電車で会社に通っている。週末は近くの公園で走っているらしい。
...
> 田中さん**は**東京に住んでいる。毎日忙しく働いている。
> 山田さん**は**大阪に住んでいる。のんびりした生活をしている。
...
- Paragraph 1: 東京**は** ... (about Tokyo)
- Paragraph 2: 大阪**は** ... (about Osaka)
- Paragraph 3: 京都**は** ... (about Kyoto)
...
> 日本の教育**は**独特だ。小学校**は**六年間で、子どもたちは毎日給食を食べる。中学校**は**三年間で、部活動が重要になる。
...
> 田中さんは毎日同じカフェに行く。いつも同じ席に座って、コーヒーを飲む。ある日、知らない女の人**が**隣に座った。
...
> 犬**が**賢い動物だ。
> "Dogs are (the) intelligent animals."
...
> きれいな花**は**咲いている。
> "Beautiful flowers are (indeed) blooming."
...
> 日本**は**四季がある美しい国だ。 (は: setting up Japan as the known topic for what follows)
> 日本**が**四季がある美しい国だと、多くの外国人は言う。 (が: identifying Japan as the one that matches the description)
...
> 驚いた**のは**、彼が何も言わなかったことだ。
> "What surprised me was that he said nothing." (は: the surprising thing is the topic; the content is the comment)

> 驚いた**のが**、彼が何も言わなかったことだ。
> "What surprised me was that he said nothing." (が: identifying which thing surprised me)
...
**Paragraph 1:**
- リサさん**は** — establishing the main topic of the entire passage.
- 毎日**が**新しい発見の連続だ — 毎日 takes が because the sentence identifies what each day is (exhaustive が with a copula-like structure). It answers "What is each day like?" not "What about each day?"

**Paragraph 2:**
- 朝**は**早い — 朝 is topicalized; the passage shifts to mornings.
- 目覚まし時計**が**鳴ると — inside a conditional clause (と), the subject takes が (Section 2.4).
- 朝ごはん**は**いつもパンとコーヒーだ — breakfast is topicalized.
- 魚や味噌汁**が**出る — inside a reported-speech clause (と聞いていた), が marks the subject.
- そんなにたくさん**は**食べられない — は on the degree expression with negation (Section 1.4 — negated elements take は).
- パンだけ**は**毎日食べる — contrastive は: bread at the very least.

**Paragraph 3:**
- 大学まで**は** — までは: topicalized endpoint (Section 1.6).
- 漢字**が**難しくて — が with a stative predicate (difficult).
- 内容**は**とてもおもしろい — contrastive は: the content (as opposed to the kanji) is interesting.

**Paragraph 4:**
- 授業**は**十時からだ — topicalized.
- 予習をするの**が**リサさんの習慣だ — が identifies what Lisa's habit is (exhaustive).
- 知らない学生**が**隣に座る — new person appearing: が for new information.
- 自分の気持ちをうまく伝えるの**は**、まだ難しい — the nominalized action is topicalized; the comment is that it's still difficult.

**Paragraph 5:**
- 授業**が**終わると — inside a temporal conditional (と), が marks the subject.
- 日本語**が**上手な友達**は**キムさんだ — が with the stative predicate 上手; は on the overall topic (the friend).
- 漢字**が**読めるので — が with the potential predicate 読める, inside a reason clause (ので).
- 英語**は**リサさんのほうが得意だ — contrastive は on English; が with 得意.

**Paragraph 6:**
- 電車の音**が**聞こえる — が with the perception verb 聞こえる (Section 2.3).
- 東京**は**夜でもにぎやかだ — topic.
- この街**が**好きだ — が with the stative predicate 好き.
- いろいろなこと**が**あって — が with ある (existence).
- 退屈すること**は**ない — は with negative (Section 1.4).

**Paragraph 7:**
- 古いお寺**が**たくさんある — が with ある inside a reported clause.
...
|------|---------|-------|---------------|---------|
| 留学生 | りゅうがくせい | ④ | noun | exchange/international student |
| 発見 | はっけん | ⓪ | noun | discovery |
| 連続 | れんぞく | ⓪ | noun | continuity, series, streak |
| 目覚まし時計 | めざましどけい | ⑤ | noun | alarm clock |
| 味噌汁 | みそしる | ③ | noun | miso soup |
| 辞書 | じしょ | ① | noun | dictionary |
| 引く | ひく | ⓪ | 五段 verb | to pull; to look up (in a dictionary) |
| 内容 | ないよう | ⓪ | noun | content, substance |
| 予習 | よしゅう | ⓪ | noun | preparation for class, preview study |
| 習慣 | しゅうかん | ⓪ | noun | habit, custom |
| 集中する | しゅうちゅうする | ⓪ | する verb | to concentrate |
| 話しかける | はなしかける | ⑤ | 一段 verb | to start talking to, to approach (someone) |
| 気持ち | きもち | ⓪ | noun | feeling, mood |
| 伝える | つたえる | ⓪ | 一段 verb | to convey, to communicate |
| うらやましい | — | ⑤ | い-adjective | envious, jealous (in a mild sense) |
| お互いに | おたがいに | ⓪ | adverb | mutually, each other |
| 教え合う | おしえあう | ④ | 五段 verb | to teach each other |
| 退屈する | たいくつする | ⓪ | する verb | to be bored |
| 田舎 | いなか | ⓪ | noun | countryside, rural area |
| 春休み | はるやすみ | ③ | noun | spring break |
| 予定 | よてい | ⓪ | noun | plan, schedule |
| 楽しみ | たのしみ | ③ | noun | something to look forward to; pleasure |
| 独特 | どくとく | ⓪ | noun / な-adj | unique, distinctive |
| 給食 | きゅうしょく | ⓪ | noun | school lunch (provided meal) |
| 通う | かよう | ⓪ | 五段 verb | to commute, to attend regularly |
